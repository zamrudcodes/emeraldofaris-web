...
- 🆕 **Sales 9-hari (Jun 1 – Jun 9):** Rp 68.8M (Mon) → Rp 20.8M (Tue) → Rp 24.7M (Wed) → Rp 20.3M (Thu) → Rp 27.6M (Fri) → Rp 51.8M (Sat) → Rp 77.6M (Sun) → Rp 29.2M (Mon) → Rp 28.4M (Tue). Weekday baseline ~Rp 20-29M (Tue-Fri + new Mon) terkonfirmasi. Monday outlier (Jun 1: Rp 68.8M) dikonfirmasi sebagai anomali oleh Monday normal (Jun 8: Rp 29.2M). Tuesday stabil di Rp 20.8M dan Rp 28.4M — variasi normal weekday. Weekend (Sat-Sun) ~Rp 52-78M, rasio weekend vs weekday ~3-4:1.
...
- 🟢 **ESB sales:** 10 hari data (May 31 – Jun 9) — threshold analisis tren tercapai ✅
...
4. Weekday baseline ~Rp 20-29M sudah terkonfirmasi dengan 7 hari data (Mon-Fri, dua minggu +). Monday outlier Jun 1 (Rp 68.8M) dikonfirmasi anomali oleh Monday normal Jun 8 (Rp 29.2M) — kemungkinan efek libur/Lebaran carryover. Tuesday stabil ~Rp 20-28M (dua data point: Jun 2 Rp 20.8M, Jun 9 Rp 28.4M). Jun 7 (Sun) Rp 77.6M dengan 411 bills dan AOV Rp 189K — ini puncak baru tertinggi. Apakah ada event khusus?
